...
\node {/}
child { node {users}}
child { node {users} child { node {users}}};
}
\end{tikzpicture}
\end{column}%
\end{columns}
...
\only<7>{%
\frametitle{User accounts}
}%

\only<8-11>{%
\frametitle{Create resource}
}%

\only<12-13>{%
\frametitle{Delete resource}
}%
...
\only <1>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/1-ecran-create-user}};
     \end{tikzpicture}
}%
...
\only <7>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/7-ecran-create-user}};
     \end{tikzpicture}
}%
...
\only <14>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/8-ecran-create-user}};
     \end{tikzpicture}
}%
...
\only <15>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/6-ecran-create-resource}};
     \end{tikzpicture}
}%
...
\only <20>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/5-ecran-create-project}};
     \end{tikzpicture}
}%
...
\only <21>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/6-ecran-create-project}};
     \end{tikzpicture}
}%
...
\only <22>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/7-ecran-create-project}};
     \end{tikzpicture}
}%
...
\only <23>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/8-ecran-create-project}};
     \end{tikzpicture}
}%
...
\only <24>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/9-ecran-create-project}};
     \end{tikzpicture}
}%
...
\only <25>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/10-ecran-create-project}};
     \end{tikzpicture}
}%
...
\only <26>{%
    \begin{tikzpicture}
          \node
              [anchor=north]
              at (0,0)
              {\includegraphics[width=10cm, height=8cm]{img/11-ecran-create-project}};
     \end{tikzpicture}
}%
